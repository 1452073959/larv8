...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection deal_create_time
     * @property Grid\Column|Collection deal_date
     ...
     * @method Grid\Column|Collection deal_create_time(string $label = null)
     * @method Grid\Column|Collection deal_date(string $label = null)
     ...
     * @property Show\Field|Collection deal_create_time
     * @property Show\Field|Collection deal_date
     ...
     * @method Show\Field|Collection deal_create_time(string $label = null)
     * @method Show\Field|Collection deal_date(string $label = null)
